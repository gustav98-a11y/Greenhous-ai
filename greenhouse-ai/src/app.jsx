  ...
  async function analyze(b64, mediaType="image/jpeg") {
    try {
      ...
      setResult({
        ...
        urgent_actions:[],
        recommended_actions:[
          e.message?.includes("429")||e.message?.includes("många")?"⏳ Vänta 1 minut och försök igen — Gemini har en gräns på 15 analyser/minut":"Försök igen med en tydlig bild i bra ljus",
          "Se till att bilden är JPG eller PNG under 5 MB",
          "Bra ljus och tydlig bild ger bäst resultat"
        ],
        confidence:0,
        care_tips:"",
        next_week_tasks:[]
